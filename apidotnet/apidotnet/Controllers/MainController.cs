    ...
    public class MainController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetModuleData(int moduleId)
        {
            try
            {
                ...
                // Call the stored procedure to calculate the value
                int forModulePointsLessNextTimeIfNotThenPointsNotInHistoryButInRevision = _context.NextPointInModule(userId ?? 0, moduleId);
